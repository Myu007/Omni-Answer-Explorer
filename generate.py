...
Usage:
    python generate.py          # uses GROQ_API_KEY from config below or env var
    GROQ_API_KEY=gsk_xxx python generate.py   # override via env
...
GROQ_API_KEY = os.environ.get("GROQ_API_KEY") or "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"
